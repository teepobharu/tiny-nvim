...
return {
  ...
  -- CodeCompanion config moved to lua/plugins/extra/myAi.lua
  -- (original 550+ line block removed - see git history for reference)
  --[=[ codecompanion_removed_block_start
  {
